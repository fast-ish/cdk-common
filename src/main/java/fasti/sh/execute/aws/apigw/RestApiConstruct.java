...
import fasti.sh.model.aws.apigw.ApiRequestSchema;
...
/**
 * Comprehensive Amazon API Gateway REST API construct that provisions fully configured API endpoints with validation, authorization,
 * logging, and monitoring capabilities.
 *
 * <p>
 * This construct provides enterprise-grade API Gateway setup with advanced features:
 *
 * <p>
 * <b>Core API Features:</b>
 *
 * <ul>
 * <li><b>REST API Creation</b> - Configurable API with custom domain and endpoint types
 * <li><b>Request Validation</b> - Schema-based validation for request bodies and parameters
 * <li><b>Response Models</b> - Structured response schemas for API documentation
 * <li><b>Authorization</b> - Integration with Cognito User Pools and IAM
 * <li><b>Logging & Monitoring</b> - CloudWatch integration with custom log formats
 * </ul>
 *
 * <p>
 * <b>Validation & Schema Management:</b>
 *
 * <ul>
 * <li><b>Request Validators</b> - Body and parameter validation with custom rules
 * <li><b>JSON Schema Models</b> - Dynamic model creation from configuration
 * <li><b>Response Templates</b> - Structured response formatting and error handling
 * <li><b>Content Type Handling</b> - Multi-format request/response processing
 * </ul>
 *
 * <p>
 * <b>Authorization Integration:</b>
 *
 * <ul>
 * <li><b>Cognito Integration</b> - User pool-based authentication and authorization
 * <li><b>IAM Authorization</b> - Role-based access control with AWS credentials
 * <li><b>API Key Management</b> - Usage plans and throttling controls
 * <li><b>CORS Support</b> - Cross-origin resource sharing configuration
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>CloudWatch Logs</b> - Dedicated log groups with custom retention
 * <li><b>Access Logging</b> - Request/response logging with customizable formats
 * <li><b>Execution Logging</b> - Method-level execution tracing and debugging
 * <li><b>Metrics & Alarms</b> - Performance monitoring and alerting integration
 * </ul>
 *
 * <p>
 * <b>Stage Management:</b> The construct supports multiple deployment stages with independent configuration:
 *
 * <ul>
 * <li>Per-stage logging and monitoring settings
 * <li>Stage-specific throttling and caching policies
 * <li>Environment-based variable injection
 * <li>Blue/green deployment support
 * </ul>
 *
 * <p>
 ...
 * <li>Dynamic model creation from JSON schemas
 * <li>Flexible authorizer assignment per method
 * <li>Custom response codes and error handling
 * </ul>
 *
 * <p>
 * <b>Usage Example:</b>
 *
 * <pre>{@code
 * RestApiConstruct api = new RestApiConstruct(this, common, apiConfig, authorizers);
 *
...
public class RestApiConstruct extends Construct {
  ...
  private @NotNull List<UsagePlanConstruct> usagePlans(Common common, ApiConf conf) {
    return conf.usagePlans().stream().map(plan -> new UsagePlanConstruct(this, common, plan, this.api())).toList();
  }
