 ...
 *
 * <ul>
 * <li><b>id</b> - Unique resource identifier derived from deployment context
 * <li><b>account</b> - AWS account ID for resource deployment
 * <li><b>region</b> - AWS region for resource provisioning
 * <li><b>organization</b> - Organizational unit or team identifier
 * <li><b>environment</b> - Deployment environment (dev, staging, prod)
 * <li><b>version</b> - Application or infrastructure version
 * <li><b>domain</b> - DNS domain for public-facing resources
 * <li><b>tags</b> - Common tags applied to all provisioned resources
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Deterministic IDs</b> - SHA-256 hash-based generation from input strings
 * <li><b>Base32 Encoding</b> - URL-safe encoding with case normalization
 * <li><b>AWS Compliance</b> - Ensures first character is alphabetic for AWS resource naming
 * <li><b>Collision Resistance</b> - Cryptographically secure hash ensures uniqueness
 * <li><b>Random IDs</b> - SecureRandom-based generation for temporary identifiers
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Priority-based Merging</b> - Later maps override earlier ones for conflicts
 * <li><b>Null-safe Operations</b> - Graceful handling of null or empty tag maps
 * <li><b>Multimap Support</b> - Merge up to three tag maps in a single operation
 * <li><b>Immutable Results</b> - Returns new maps without modifying inputs
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li>Uses SHA-256 for cryptographically secure ID generation
 * <li>Employs SecureRandom for unpredictable random ID creation
 * <li>Normalizes case to prevent AWS resource naming conflicts
 * <li>Truncates to 15 characters for AWS resource name constraints
 * </ul>
 *
 * <p>
 ...
 *   .tags(Map.of("Team", "Platform", "Cost", "Engineering"))
 *   .build();
 *
