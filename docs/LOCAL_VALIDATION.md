...
Run these commands locally to validate your code before pushing to GitHub. These
mirror the checks performed by the GitHub Actions workflow.
...
4. **First time setup**: OWASP check downloads a large database on first run (
...
5. **OWASP vulnerabilities**: Update dependencies or add suppressions to
