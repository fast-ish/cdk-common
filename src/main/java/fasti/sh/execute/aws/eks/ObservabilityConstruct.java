...
import fasti.sh.model.aws.cloudwatch.AlarmConf;
import fasti.sh.model.aws.cloudwatch.DashboardConf;
import fasti.sh.model.aws.cloudwatch.MetricFilterConf;
import fasti.sh.model.aws.cloudwatch.ObservabilityConf;
 ...
 *
 * <ul>
 * <li><b>Metric Collection</b> - Log-based metric filters for custom application metrics
 * <li><b>Alerting</b> - CloudWatch alarms with configurable thresholds and conditions
 * <li><b>Notifications</b> - SNS topics with email subscriptions for alert delivery
 * <li><b>Dashboards</b> - CloudWatch dashboards for metric visualization and analysis
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li>Dynamic metric filter creation from log patterns with custom namespaces
 * <li>Configurable alarm conditions with multiple comparison operators and statistics
 * <li>Multi-subscriber SNS topics with email distribution lists
 * <li>Template-based dashboard configuration with JSON body processing
 * <li>Comprehensive error handling with failed resource filtering
 * <li>Automatic resource tagging with common and component-specific tags
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Metric Filters</b> - Extract metrics from CloudWatch Logs using literal patterns
 * <li><b>Alarm Types</b> - Support for threshold, anomaly detection, and composite alarms
 * <li><b>Notification Channels</b> - Email, SMS, and webhook integrations via SNS
 * <li><b>Dashboard Widgets</b> - Metrics, logs, and custom visualization components
 * </ul>
 *
 * <p>
...
public class ObservabilityConstruct extends Construct {
  ...
  private List<Alarm> createAlarms(Construct scope, Common common, List<AlarmConf> alarms) {
    ...
    return alarms.stream().map(conf -> {
      try {
        var metric = new Metric(MetricProps
          .builder()
        ...
        var alarmBuilder = Alarm.Builder
          .create(scope, id("alarm", conf.name()))
          .alarmName(conf.name())
          .metric(metric)
