...
import fasti.sh.model.aws.cognito.client.ClientAttributesConf;
import fasti.sh.model.aws.cognito.client.UserPoolClientConf;
            ...
            OAuthSettings
              ...
              .flows(
                OAuthFlows
                  ...
                  .build())
              .scopes(conf.oauth().scopes().stream().map(UserPoolClientConstruct::scope).toList())
