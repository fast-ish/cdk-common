 ...
 *
 * <ul>
 * <li><b>Usage Plan Creation</b> - API Gateway usage plans with configurable access policies
 * <li><b>Throttling Controls</b> - Request rate limiting and burst protection
 * <li><b>Quota Management</b> - Time-based request quotas and usage limits
 * <li><b>API Key Integration</b> - Automatic API key provisioning and association
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Rate Limiting</b> - Requests per second throttling with configurable limits
 * <li><b>Burst Protection</b> - Short-term traffic spike handling with burst allowances
 * <li><b>Quota Enforcement</b> - Daily, weekly, monthly usage quotas with automatic reset
 * <li><b>Stage Association</b> - Per-stage usage plan deployment and management
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Automatic Generation</b> - Secure API key creation with unique identifiers
 * <li><b>Plan Association</b> - Binding API keys to specific usage plans
 * <li><b>Access Control</b> - Key-based access restriction and authorization
 * <li><b>Usage Tracking</b> - Key-level consumption monitoring and analytics
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Customer Segmentation</b> - Different usage tiers for different customer types
 * <li><b>Service Level Agreements</b> - SLA enforcement through quota and throttling
 * <li><b>Revenue Protection</b> - Usage limits to prevent cost overruns
 * <li><b>Fair Use Policies</b> - Balanced resource allocation across consumers
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Rate Limiting</b> - Sustained requests per second with smooth distribution
 * <li><b>Burst Handling</b> - Short-term traffic spikes with token bucket algorithm
 * <li><b>Queue Management</b> - Request queuing and overflow protection
 * <li><b>Back-pressure</b> - Graceful degradation under high load conditions
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Time-Based Limits</b> - Daily, weekly, monthly quota periods
 * <li><b>Automatic Reset</b> - Quota counter reset at period boundaries
 * <li><b>Consumption Tracking</b> - Real-time usage monitoring and alerting
 * <li><b>Overage Handling</b> - Configurable behavior when quotas are exceeded
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Usage Monitoring</b> - CloudWatch metrics and dashboards for consumption analysis
 * <li><b>Alerting Integration</b> - Automated alerts for quota violations and high usage
 * <li><b>Cost Management</b> - Usage-based billing and cost allocation
 * <li><b>Performance Optimization</b> - Traffic shaping for optimal resource utilization
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Multi-Stage Support</b> - Usage plans across development, staging, production
 * <li><b>Customer Onboarding</b> - Automated API key provisioning workflows
 * <li><b>Usage Analytics</b> - Integration with analytics platforms for consumption insights
 * <li><b>Billing Integration</b> - Usage data export for billing and revenue management
 * </ul>
 *
 * <p>
...
public class UsagePlanConstruct extends Construct {
  ...
  public UsagePlanConstruct(Construct scope, Common common, UsagePlanConf conf, RestApi restApi) {
    ...
    maybeApplyQuota(usagePlanBuilder, conf);

    this.usagePlan = usagePlanBuilder.build();
