...
@Slf4j
@Getter
public class SynthesizerRolesNestedStack extends NestedStack {
  ...
  public SynthesizerRolesNestedStack(Construct scope, Common common, SynthesizerResources conf, NestedStackProps props) {
