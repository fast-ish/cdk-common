 ...
 *
 * <p>
 * This construct deploys the Grafana Alloy Operator, which is required for the k8s-monitoring chart v3+ to function properly. The operator
 * manages Alloy instances as Custom Resources and provides the necessary CRDs and infrastructure.
 *
 * <p>
 * <b>Core Capabilities:</b>
 *
 * <ul>
 * <li><b>Alloy CRD Management</b> - Installs and manages Alloy Custom Resource Definitions
 * <li><b>Operator Deployment</b> - Deploys the Alloy Operator controller for managing Alloy instances
 * <li><b>Context Validation</b> - Validates Grafana Cloud context before deployment via base class
 * <li><b>Dependency Management</b> - Ensures proper deployment order with k8s-monitoring chart
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Grafana Context</b> - Requires valid Grafana Cloud configuration in CDK context
 * <li><b>EKS Cluster</b> - Must be deployed to an existing EKS cluster
 * <li><b>k8s-monitoring Prerequisite</b> - Required for k8s-monitoring chart v3.0+
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Namespace</b> - Deployed to alloy-system namespace
 * <li><b>Chart Version</b> - Uses Grafana's official alloy-operator Helm chart
 * <li><b>Resource Limits</b> - Configured with appropriate CPU and memory limits
 * <li><b>Timeout</b> - 5-minute deployment timeout for operator readiness
 * </ul>
 *
 * <p>
 * <b>Integration with Grafana Stack:</b> The Alloy Operator is a critical component of the modern Grafana observability stack:
 *
 * <pre>
 ...
 *
 * <pre>{@code
 * AlloyOperatorConstruct alloyOperator = new AlloyOperatorConstruct(this, common, alloyOperatorConfig, cluster);
 *
...
public class AlloyOperatorConstruct extends GrafanaBaseConstruct {
   ...
   *
   * <p>
   * This constructor validates Grafana Cloud context (inherited from base class), processes the mustache template for operator
   * configuration, and deploys the alloy-operator Helm chart which provides the necessary CRDs and operator for k8s-monitoring chart v3+
   * compatibility.
   *
   * <p>
   * The deployment will be skipped gracefully if Grafana Cloud context is not properly configured, ensuring that the entire observability
   * stack deploys as a cohesive unit.
   *
   * @param scope
   ...
   * @param conf
   *          Alloy Operator addon configuration including chart details and values template
   * @param cluster
