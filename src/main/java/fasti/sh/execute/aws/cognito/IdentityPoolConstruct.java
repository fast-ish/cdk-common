...
import fasti.sh.model.aws.cognito.identitypool.IdentityPoolConf;
 ...
 *
 * <ul>
 * <li><b>Identity Pool Creation</b> - Cognito Identity Pool with federated identity support
 * <li><b>Role Mapping</b> - Sophisticated IAM role assignment based on authentication state
 * <li><b>Authentication Providers</b> - Integration with User Pools, SAML, OIDC, and social providers
 * <li><b>Custom Resource Management</b> - AWS SDK-based custom resources for advanced configuration
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Multi-Provider Support</b> - User Pools, Facebook, Google, Amazon, Twitter, SAML, OIDC
 * <li><b>Role-Based Access</b> - Different IAM roles for authenticated vs unauthenticated users
 * <li><b>Dynamic Role Assignment</b> - Context-based role mapping with custom rules
 * <li><b>Cross-Platform Identity</b> - Unified identity across web, mobile, and server applications
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Authenticated Roles</b> - Full-access roles for verified users
 * <li><b>Unauthenticated Roles</b> - Limited-access roles for anonymous users
 * <li><b>Custom Role Mapping</b> - Advanced role selection based on user attributes
 * <li><b>Policy Templates</b> - Template-based policy generation with environment variables
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>SDK-Based Operations</b> - Direct AWS SDK calls for Identity Pool configuration
 * <li><b>Advanced Settings</b> - Configuration options not available in CDK constructs
 * <li><b>Dynamic Updates</b> - Runtime configuration changes through custom resources
 * <li><b>Error Handling</b> - Robust error handling and rollback mechanisms
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>SAML Providers</b> - Enterprise identity provider integration
 * <li><b>OIDC Providers</b> - OpenID Connect federation
 * <li><b>Social Providers</b> - Facebook, Google, Amazon, Twitter integration
 * <li><b>Developer Providers</b> - Custom authentication backend integration
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Principle of Least Privilege</b> - Minimal necessary permissions for each role
 * <li><b>Cross-Account Access</b> - Support for cross-account identity federation
 * <li><b>Audit Trail</b> - CloudTrail integration for identity operations
 * <li><b>Compliance Ready</b> - GDPR, HIPAA, and SOC compliance considerations
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Environment-Specific Providers</b> - Different identity providers per environment
 * <li><b>Dynamic Role Policies</b> - Environment-specific IAM permissions
 * <li><b>Provider Configuration</b> - Parameterized external provider settings
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Web Applications</b> - JavaScript SDK integration with CORS support
 * <li><b>Mobile Apps</b> - iOS and Android SDK integration
 * <li><b>Server Applications</b> - Backend service integration
 * <li><b>Hybrid Architectures</b> - Mixed client/server authentication patterns
 * </ul>
 *
 * <p>
 * <b>Usage Example:</b>
...
public class IdentityPoolConstruct extends Construct {
  ...
  public IdentityPoolConstruct(Construct scope, Common common, String identityPool, UserPool userPool, UserPoolClient userPoolClient,
    ...
    this.identityPool =
      Builder
        ...
        .roleMappings(
          conf
            .userPoolRoleMappings()
            .stream()
            .map(
              mapping -> IdentityPoolRoleMapping
                .builder()
  ...
  private void cleanupTrustPolicy() {
    ...
    AwsCustomResource.Builder
      .create(this, "CustomResourceUpdateTrustPolicy")
      .onCreate(cleanup)
      .onUpdate(cleanup)
      .policy(
  ...
  private void applyPrincipalTags(UserPool userPool) {
    var applyAttributesForAccessControl = AwsSdkCall
      .builder()
      ...
      .parameters(
        Map
          .of(
            ...
            userPool.getUserPoolProviderName(),
            "PrincipalTags",
            Map.of("sub", "cognito-identity.amazonaws.com:sub"),
            "UseDefaults",
            Boolean.TRUE))
