 ...
 *
 * <ul>
 * <li><b>Multi-Factor Authentication</b> - SMS, TOTP, and hardware token support
 * <li><b>Password Policies</b> - Complexity requirements and rotation policies
 * <li><b>Sign-in Methods</b> - Username, email, phone number authentication
 * <li><b>Account Recovery</b> - Password reset and account recovery workflows
 * <li><b>User Verification</b> - Email and SMS verification processes
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Standard Attributes</b> - AWS-defined user attributes (email, name, etc.)
 * <li><b>Custom Attributes</b> - Application-specific user data fields
 * <li><b>User Groups</b> - Role-based grouping and permissions
 * <li><b>Device Tracking</b> - Remember and track user devices
 * <li><b>Self Registration</b> - Allow users to create their own accounts
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>SES Integration</b> - Amazon SES for email delivery and verification
 * <li><b>SNS Integration</b> - Amazon SNS for SMS messaging and notifications
 * <li><b>Lambda Triggers</b> - Custom business logic integration at auth events
 * <li><b>Advanced Threat Protection</b> - AWS WAF and IP blocking integration
 * </ul>
 *
 * <p>
 ...
 *
 * <ul>
 * <li><b>Deletion Protection</b> - Prevent accidental user pool deletion
 * <li><b>Case Sensitivity</b> - Configure username case handling
 * <li><b>Threat Protection</b> - Automated security threat detection and mitigation
 * <li><b>Attribute Preservation</b> - Control which attributes to keep during updates
 * </ul>
 *
 * <p>
 ...
 * @param featurePlan
 *          AWS Cognito feature plan tier (LITE, ESSENTIALS, or PLUS)
 * @param removalPolicy
